...
def create_user(self,username,usermail):
    assert click_button(self,By.XPATH,"//span[contains(.,'Add User')]","Add User","Click Add User") == True
    assert set_text(self,By.XPATH,"//input[@name='name']",username,"set user name") == True
    assert set_text(self,By.XPATH,"//input[@name='email']",usermail+"@geminiopencloud.com","set user email") == True
    assert click_button(self,By.XPATH,"//span[contains(.,'Submit')]","Submit","Click Submit") == True
    time.sleep(3)
    result = get_text(self,By.XPATH,"//span/div/div/div/div[2]","get submit message")
...
def delete_user(self,host):
      try:
          for i in range(2, 50, 1):
            ...
            username=(get_text(self,By.XPATH,user_target,"Get user name to delete"))
...
def enble_project_solution(self,slidc_button,solution_select):
    
          try:
              slide_button=slidc_button
              time.sleep(1)                
              if int(self.driver.execute_script(slide_button)) <39:
