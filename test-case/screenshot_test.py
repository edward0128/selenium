...
class SeleniumTest():
  ...
  def setup_method(self):
    ...
    self.vars["k8s_name"] = config.get("k8s","k8s_name").split(",")
    #for test in self.vars["k8s_name"]:
    #  print(test)
    self.vars["k8s_ip"] = config.get("k8s","k8s_ip").split(",")
    #for test in self.vars["k8s_ip"]:
    #  print(test)
  ...
  def Test_0004(self):
    ...
    try:
      ...
      click_host=self.driver.find_element(By.XPATH, "//ul[@id='/admin/infra_mgmt$Menu']/li")
    ...
    try:
      ...
      for i in range(1, 10, 1):
        ...
        test=self.driver.find_element(By.XPATH, "//tr[%s]/td[%s]/span" % (str(i),3))
        highlight(test)
        ...
        #color =image.getpixel((left+5,top))
        #print(color
