...
class SeleniumTest():
  ...
  def SA_0028(self):
    ...
    check_text(self,By.XPATH,"//ul[@id='/admin$Menu']/li[6]","Flavors","check Flavors")
    click_button(self,By.XPATH,"//ul[@id='/admin$Menu']/li[6]","Flavors","click Flavors button")
    logging.info("---------click flavors button-------")
    flag=delete_flavor(self)
    
    if flag:
      click_button(self,By.XPATH,"//button/span/i","","click delete")
